...
export default function SignUp() {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-[#FCFCFC] dark:bg-[#10172A] px-4 py-10 overflow-hidden">
      ...
      >
        {/* Left — branded panel */}
        <div className="relative hidden md:flex md:w-2/5 flex-col justify-between p-8 bg-gradient-to-br from-purple-600 to-pink-500 overflow-hidden">
          {/* decorative dot grid */}
          <svg
